...
class Contact extends React.Component {
  ...
  sendEmail(e) {
    ...
    const queryString = Object.keys(send)
  ...
  render() {
    return (
      <div className="container__main ">
        <div
          className="left__block__success"
          style={{ display: this.state.success }}
        >
          <img src={require(`../img/success.png`)} alt="success" />
        </div>
        <div className="left__block1" style={{ display: this.state.form }}>
          ...
          <div className="fields">
            ...
            >
              ...
              <div className="group text__area1">
                <input
                  type="text"
                  name="entry.451808494"
                  onChange={event => this.getText(event.target.value)}
                  required
                />
                <span class="bar"></span>
                <label>{`${
